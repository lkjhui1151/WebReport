...
path = "D:\INET-MS\Auto report\GitHub\WebReport\code_krit\\report_VASCAN\\"
doc = DocxTemplate(path,"templateNessus.docx")
...
csvFilePath = path,'Network Cloud.csv'
jsonFilePath = path,'dataNessus.json'

# <--Burp-->
csvFilePath2 = path,'Burp.csv'
jsonFilePath2 =path,'dataBurp.json'
...
doc.render(contents)
doc.save("path"+name[0]+" Nessus"+".docx")
